...
export function CoachCard({
  ...
  return (
    <div className={`w-full max-w-[340px] h-[640px] bg-black flex flex-col p-1 border-[5px] ${theme.border} ${theme.glow} rounded-[3rem] overflow-hidden relative shadow-2xl`}>
