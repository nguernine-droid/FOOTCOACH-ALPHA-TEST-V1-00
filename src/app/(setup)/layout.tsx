  ...
  return (
    <div className="min-h-screen bg-black relative overflow-x-hidden">
      ...
      */}
      ...
      {/* Fond avec la grille Cyberpunk légère (Orange par défaut) */}
      <div className="fixed inset-0 opacity-5 bg-[linear-gradient(rgba(255,107,0,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,107,0,0.1)_1px,transparent_1px)] bg-[size:30px_30px] pointer-events-none z-0" />
