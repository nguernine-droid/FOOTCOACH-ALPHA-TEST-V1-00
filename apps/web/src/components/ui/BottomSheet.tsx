...
export function BottomSheet({
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 z-50 flex items-end min-[960px]:items-center justify-center bg-navy-900/50 min-[960px]:p-6",
    ...
    >
      <div
        ...
        className={cn(
          "w-full min-[960px]:max-w-lg bg-white rounded-t-2xl min-[960px]:rounded-2xl shadow-pop outline-none",
      ...
      >
        ...
        {footer && (
          <div className="shrink-0 border-t border-line bg-white rounded-b-2xl px-5 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] min-[960px]:pb-3">
            {footer}
          </div>
        )}
